...
class AppColors {
  static const Color primaryBrown = Color(
    0xFF85380C,
  ); // Rich dark warm brown (App bar title & main icons)
  static const Color accentOrange = Color(
    0xFFB55B1B,
  ); // Warm cognac/amber orange for accents & filter
  static const Color background = Color(
    0xFFFFF6F1,
  ); // Soft warm cream background
  static const Color cardBackground = Color(
    0xFFFFFFFF,
  ); // Pure white for cards & search bar
  static const Color textPrimary = Color(
    0xFF2C1E16,
  ); // Dark rich warm brown for recipe titles
  static const Color textSecondary = Color(
    0xFF544035,
  ); // Medium warm brown for recipe count & subtitles
  static const Color subtleBorder = Color(0xFFF0E6DF); // Soft subtle border
  ...
  static const Color navUnselected = Color(
    0xFF9E8A7E,
  ); // Muted warm taupe for inactive nav items
  static const Color darkBrown = Color(
    0xFF85380C,
  ); // Warm dark brown for headers & search icon
  static const Color searchHint = Color(
    0xFFA89C94,
  ); // Soft warm gray for search placeholder text
}
